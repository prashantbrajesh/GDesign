...
public class BatchConfiguration {
    ...
    @Bean
    public MyPersonItemProcessor myProcessor() {
        return new MyPersonItemProcessor();
    }
    @Bean
    ...
    @Bean
    public Job anotherUserJob(JobCompletionNotificationListener listener, Step step1,Step step2) {
    ...
    public Job importUserJob(JobCompletionNotificationListener listener, Step step1,Step step2) {
        return jobBuilderFactory.get("myBrajeshJob")
            .incrementer(new RunIdIncrementer())
    ...
    public Step step1(JdbcBatchItemWriter<Person> writer,JobCompletionNotificationListener listener) {
        return stepBuilderFactory.get("running brajesh step1")
    ...
    public Step step2(JdbcBatchItemWriter<Person> writer) {
        return stepBuilderFactory.get("reuning brajesh step2")
